...
module.exports = function(eleventyConfig) {
  ...
  filters
  -------------------------------------------------------------------------- */
  glob.sync(['app/filters/*.js']).forEach(file => {
...
eleventyConfig.amendLibrary("md", mdLib => {
		mdLib.use(markdownItAnchor, {
			permalink: markdownItAnchor.permalink.ariaHidden({
				placement: "after",
				class: "header-anchor text-decoration-none",
				symbol: "#",
				ariaHidden: false,
			}),
			level: [1,2,3,4],
  ...
  eleventyConfig.addPassthroughCopy({ 'app/assets/fonts': 'assets/fonts' });
  eleventyConfig.addPassthroughCopy({ 'app/assets/img': 'assets/img' });
  eleventyConfig.addPassthroughCopy({ 'app/assets/css/*.css': 'assets/'})
